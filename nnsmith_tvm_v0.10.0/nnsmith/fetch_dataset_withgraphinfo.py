...
dataset = []
models_path = 'onnx_models_gen_tvm-v0.10.0'
transform_error_dir = './transform_error_more'
...
for iteration_count in range(models_count):
    ...
    model_path_dic = "onnx_models_gen_tvm-v0.10.0/model_{}".format(iteration_count)
...
json_filename = 'onnx_models_gen_tvm-v0.10.0.json'
