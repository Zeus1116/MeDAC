...
normal_models_random_elements = random.sample(range(models_count), 3000)
for iteration_count in normal_models_random_elements:
...
error_other_random_elements = random.sample(range(models_count), 3000)
