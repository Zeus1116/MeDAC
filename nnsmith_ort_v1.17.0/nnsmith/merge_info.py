...
for iteration_count_hhh in range(1):
    ...
    error_other_random_elements = random.sample(range(models_count), 7)
    ...
    json_filename = './ort-v1.17.0-testdata_0_7/demo_test_data_info_{}.json'.format(iteration_count_hhh)
    with open(json_filename, 'w') as jsonfile:
        json.dump(shuffled_data_info_list, jsonfile, indent=4)
    
    json_filename = './ort-v1.17.0-testdata_0_7/demo_test_time_info_{}.json'.format(iteration_count_hhh)
    with open(json_filename, 'w') as jsonfile:
